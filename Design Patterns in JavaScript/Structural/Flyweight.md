...
- Operate on ranges (e.g., line numb er, start/end positions)

A space optimization techique tat lets us use less memory by storing externally the data associates with similar objects.
...
- Define the idea of 'ranges' on gomogeneous collections and atore data related to those ranges.
